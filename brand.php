...
<section class="brand_hero" style="background-image:url(img/about/about_hero.png);">
	<div class="container">
		<div class="brand_hero_inner">
			...
			<div class="brand_hero_description">
				<h1>
					Sanguis Jovis</span>
				</h1>
				<p>
					Санджовезе – главный итальянский красный сорт с латинским <br/>
					названием, которое произошло от словосочетания Sanguis Jovis <br/>
					(переводится как "кровь Юпитера").
				</p>
...
<section class="brand-herotext mt-60">
	<div class="container">

		<p class="brand-herotext__text">
		...
		<a href="#" class="brand-herotext__link">Читайте подробнее</a>
	</div>
</section>
...
<section class="brand-information">
	<div class="container">
		<div class="brand-information-pd">
			<div class="brand-information__inner">
				<img src="img/brand_logo.png" alt="">
				<h3>О бренде:</h3>
				Вопреки устоявшемуся мнению, родиной вина считается не Древняя Греция, а Грузия – там напиток начали делать
				гораздо раньше, чем в других странах. Первая же действующая винодельня была построена на территории
				современной
				Армении более 5000 лет назад. Археологам удалось обнаружить в ее стенах винный пресс, а также глиняные
				кувшины
				для ферментации вина. Цена на вино составляет 120 руб. за бутылку 0.5 л, в ассортименте представлены объемы
				от
				0.1 до 15 л стоимостью от 81 до 6 336 092 рублей. Продажа осуществляется в розничных магазинах Декантер в
				Москве по адресам Пресненский Вал 44, Новая Басманная 31с1, Ленинский пр-т 66, Мастеркова 1 и Сущевский Вал
				46с2 (склад), оплата наличными или банковской картой. Стоимость и наличие актуальны на 9:00 22.12.2023.<br>
				<a href="#" class="brand-herotext__link">Читайте подробнее</a>
			</div>
			<div class="brand-information__img"><img src="img/brand.png" alt="" class="brand-information__img-img"></div>
		</div>
	</div>
</section>
