...
<section class="prof-nav mt-60">
	<div class="container">
		<div class="profile-nav">
			...
			<a href="account-6.php" class="profile-nav__item profile-nav__item--active">
	...
	<div class="container">
		<div class="review_section_block">
			<div class="review_section_block_list">
				...
				<div class="review_section_block_list_inner comment">
					...
					<div class="review__list-item_description">
						...
						<a href="" class="reviews_headline_item_button">Ответить</a>
					</div>
				</div>
